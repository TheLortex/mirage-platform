...
echo "($(pkg-config libminios-xen openlibm --libs) $(cat flags/minios-libs.tmp))" > flags/minios-libs
echo "($(pkg-config libminios-xen openlibm --cflags) $(cat flags/minios-cflags.tmp))" > flags/minios-cflags
echo "($(pkg-config libminios-xen openlibm --libs) $(cat flags/posix-libs.tmp))" > flags/posix-libs
echo "($(pkg-config libminios-xen openlibm --cflags) $(cat flags/posix-cflags.tmp))" > flags/posix-cflags
