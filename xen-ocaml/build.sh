...
echo "($(pkg-config libminios-xen openlibm --libs) $(cat flags/libs.tmp))" > flags/libs
echo "($(pkg-config libminios-xen openlibm --cflags) $(cat flags/cflags.tmp))" > flags/cflags
